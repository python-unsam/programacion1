...
* Para cerrar esta clase te pedimos que recopiles las soluciones de los siguientes ejercicios:
    ...
    3. El archivo `camion_commandline.py` del [Ejercicio 3.10](../03_Contenedores_y_Errores/04_Llamados_desde_cmd.md#ejercicio-310-ejecucion-desde-la-linea-de-comandos-con-parametros-sacar-de-aca) (es adecuado el nivel?).
